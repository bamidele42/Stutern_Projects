...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/home/temitope/project/project1/.tiny_python_projectenv'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/home/temitope/project/project1/.tiny_python_projectenv/bin/deactivate.nu'
